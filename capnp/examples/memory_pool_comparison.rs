// Memory pooling performance comparison
use std::time::Instant;
use capnp::message::{Builder, HeapAllocator};

fn main() {
    println!("Memory Pooling Performance Comparison");
    println!("=====================================\n");
    ...
    // Test 3: Memory pooling (when feature is enabled)
    ...
    {
        println!("\n3. Memory Pooling");
        println!("   Feature not enabled (compile with --features memory-pooling)");
    }
    ...
    #[cfg(feature = "memory-pooling")]
    {
        println!("\nRecommendation: Enable memory-pooling feature for performance-critical applications.");
    }
}